...
extension Color {
    ...
    static let onPrimaryColor = Color(light: .white, dark: .white)
    static let onBackgroundColor = Color(light: .textBlack, dark: .white)
    static let surfaceColor = Color(light: .white, dark: .darkGrey)
    static let onSurfaceColor = Color(light: .textBlack, dark: .white)
}
