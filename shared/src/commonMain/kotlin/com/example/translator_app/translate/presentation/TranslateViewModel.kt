...
import com.example.translator_app.translate.domain.translate.TranslateException
...
class TranslateViewModel(
    ...
    private val _state = MutableStateFlow<TranslateState>(TranslateState())
    val state = combine(
        ...
        if(state.history != history){
            state.copy(
              ...
              SharingStarted.WhileSubscribed(5000L),TranslateState()
    ).toCommonStateFlow()
...
/*            TranslateEvent.RecordAudio -> { not need it here
