...
package com.example.translator_app.android.translate.presentation
...
import com.example.translator_app.android.translate.presentation.components.*
...
import com.example.translator_app.translate.presentation.TranslateState
        ...
        LazyColumn(
            ...
            item {
                ...
                TranslateTextField(
                        ...
                        onCopyClick = { text ->
                            ...
                            Toast.makeText(
                                context,
                                context.getString(com.example.translator_app.android.R.string
                                                      .copied_to_clipboard
                                ),
                                Toast.LENGTH_LONG
                            ).show()
            ...
            item {
               if(state.history.isNotEmpty()){
                   Text(
                           text = stringResource(id = com.example.translator_app.android.R.string.history),
