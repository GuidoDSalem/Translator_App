package com.example.translator_app.presentation
...
import com.example.translator_app.android.MainActivity
import com.example.translator_app.android.R
import com.example.translator_app.android.di.AppModule
import com.example.translator_app.android.voice_to_text.di.VoiceToTextModule
...
class VoiceToTextE2E {
    ...
    @get:Rule
    val perimissionRule = GrantPermissionRule.grant(
    ...
    fun recordAndTranslate() = runBlocking<Unit> {
        ...
        composeRule
            .onNodeWithContentDescription(context.getString(R.string.mic))
            .performClick()
