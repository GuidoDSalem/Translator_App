...
android {
    namespace = "com.example.translator_app.android"
    compileSdk = 33
    defaultConfig {
        applicationId = "com.example.translator_app.android"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        testInstrumentationRunner = "com.example.translator_app.TestHiltRunner"
    }
    buildFeatures {
        compose = true
    }
